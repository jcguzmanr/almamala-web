...
export default function Footer() {
  return (
    <footer className="mt-auto">
      ...
      {/* Sección principal con enlaces */}
      <div className="bg-alma-verde-profundo border-t border-alma-dorado-oscuro/20 py-12">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
      ...
      <div className="bg-alma-verde-seco/50 backdrop-blur-sm border-t border-alma-dorado-oscuro/20 py-4">
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-alma-dorado-oscuro/80">
            <p>© {new Date().getFullYear()} Todos los derechos reservados. - Alma Mala</p>
          </div>
        </div>
      </div>
    </footer>
